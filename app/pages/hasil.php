    ...
    <div class="container mt-4">
        <div class="row">
            <div class="d-flex justify-content-center align-items-center">
                <div class="col">
                    <h1 class="mb-4 text-center">List Pendaftar Beasiswa</h1>
                </div>
            </div>
        </div>
        <div class="row">
            <?php foreach ($daftars as $daftar) : ?>
                <div class="col-lg-3">
                    <div class="card">
                        <img src="<?= BASEURLIN . $daftar['file'] ?>" alt="" class="img-fluid rounded-top">
                        <div class="card-body">
                            <h5 class="card-title"><?= $daftar['nama'] ?></h5>
                            <h6 class="card-subtitle mb-2 text-body-secondary"><?= $daftar['email'] ?></h6>
                            <h6 class="card-subtitle mb-2 text-body-secondary"><?= $daftar['nomor_hp'] ?></h6>
                            <span>
                                <p class="card-text">Semester : <?= $daftar['semester'] ?> Dengan IPK Terakhir : <?= $daftar['ipk'] ?></p>
                            </span>
